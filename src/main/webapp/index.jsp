...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .product-card .body { padding: 16px 18px 14px; flex:1; display:flex; flex-direction:column; gap:6px; }
        ...
        .newsletter-wrap form input::placeholder { color: rgba(31,41,55,0.5); }
